...
def check1():
    call(["python", "testvideo0.py"])

def check2():
    call(["python", "testvideo1.py"])

def check3():
    call(["python", "testvideo2.py"])

def check4():
    call(["python", "testvideo3.py"])
...
my_canvas.create_text(490,40, text='PROXIMITY-ALERT-DETECTION-VIDEO', font=('Broadway',32),fill='yellow')
#PaleGreen1
#CadetBlue3
...
btn1.configure(activebackground="white")
btn2.configure(activebackground="white")
btn3.configure(activebackground="white")
btn4.configure(activebackground="white")

btn1.configure(background="#EAECEE")
btn2.configure(background="#EAECEE")
btn3.configure(background="#EAECEE")
btn4.configure(background="#EAECEE")
...
btn4.configure(foreground="black")
